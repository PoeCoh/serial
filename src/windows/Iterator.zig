...
pub fn init() !Iterator {
    const HKEY_LOCAL_MACHINE = @as(std.os.windows.HKEY, @ptrFromInt(0x80000002));
...
extern "advapi32" fn RegCloseKey(key: std.os.windows.HKEY) callconv(std.os.windows.WINAPI) std.os.windows.LSTATUS;
